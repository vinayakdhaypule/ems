    ...
    <div  class="alert alert-success" style="display: none;"><span class="glyphicon glyphicon-ok"></span><em> </em></div>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form id="employee_form" class="form-horizontal" role="form" method="POST" enctype="multipart/form-data" files="true">
                    ...
                    <div class="form-group">
                           ...
                           <div style = "background: #f7f8fa;padding: 50px;">
                              ...
                              <!--  <input type = "file" multiple = "multiple" 
                                  ...
                                  <input type="file" id="multi_upload" name="files" multiple>
                            </div>

                                                <div class="jFiler-items jFiler-row" >
                    <ul class="jFiler-items-list jFiler-items-grid jFiler-item-ul-del"></ul>
                    </div>
                    </div>
    ...
    $('#employee_form').submit(function(e){
       ...
       e.preventDefault();
        ...
        var formData = new FormData(this); 
             var files = document.getElementById('multi_upload').files.length;
...
var myDropzone = new Dropzone("#employee_form", {
